...
type AboutModalProps = {
  ...
  const AboutModal: React.FC<AboutModalProps> = ({ isOpen, closeModal, content }) => {
    return (
        ...
        <div className="max-w-md w-full flex flex-col items-center justify-center p-9" style={{fontFamily:'IBM MONO PLEX, monospace'}}>

            <h2 className="text-4xl text-indigo-300 font-semibold mb-4">About Quizzy App</h2>
